...
const ActivityDashboard: React.FC<ActivityDashboardProps> = ({ activityId }) => {
  ...
  const participants = [
    ...
    { id: 2, name: "Marcus Chen", avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80", checkIns: 26, streak: 8 },
    { id: 3, name: "Aisha Patel", avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80", checkIns: 24, streak: 12 },
    { id: 4, name: "James Wilson", avatar: "https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80", checkIns: 22, streak: 6 },
    { id: 5, name: "Emma Davis", avatar: "https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80", checkIns: 20, streak: 4 },
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="p-6 border border-white/80 rounded-2xl shadow-sm bg-white/90 backdrop-blur-sm hover:shadow-md transition-all duration-300">
            <h3 className="text-lg font-semibold mb-4 bg-gradient-to-r from-buddy-purple to-buddy-blue bg-clip-text text-transparent">Weekly Check-in Activity</h3>
            <div className="h-64">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-buddy-gray-200/50">
                    <th className="px-4 py-3 text-left text-sm font-medium text-buddy-gray-500">Participant</th>
                    <th className="px-4 py-3 text-left text-sm font-medium text-buddy-gray-500">Check-ins</th>
                    <th className="px-4 py-3 text-left text-sm font-medium text-buddy-gray-500">Streak</th>
                    <th className="px-4 py-3 text-left text-sm font-medium text-buddy-gray-500">Last 7 Days</th>
                  </tr>
                </thead>
                <tbody>
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center">
                          <Avatar 
                            ...
                            size="sm"
                          />
                          <span className="font-medium text-buddy-gray-800">{participant.name}</span>
                        </div>
                      </td>
                      <td className="px-4 py-3">
                        <HoverCard>
                          ...
                          <HoverCardContent className="w-80 p-4 border-buddy-gray-200/80 rounded-xl shadow-md bg-white/95 backdrop-blur-sm">
                            <div className="space-y-2">
                              <h4 className="text-sm font-semibold">{participant.name}'s Activity</h4>
                              <p className="text-sm text-buddy-gray-600">
                                Joined 3 weeks ago and has been consistently checking in.
                              </p>
                              <div className="grid grid-cols-2 gap-2 pt-2">
                                <div className="bg-buddy-gray-100/70 p-2 rounded-md">
                                  <p className="text-xs text-buddy-gray-500">Completion Rate</p>
                                  <p className="font-medium">{Math.round(participant.checkIns / 30 * 100)}%</p>
                                </div>
                                <div className="bg-buddy-gray-100/70 p-2 rounded-md">
                                  <p className="text-xs text-buddy-gray-500">Best Day</p>
                      ...
                      <td className="px-4 py-3">
                        <div className="flex space-x-1">
                          {[...Array(7)].map((_, i) => {
                            ...
                            return completed ? (
                              <CheckCircle key={i} className="h-4 w-4 text-buddy-green" />
                            ) : (
                              <XCircle key={i} className="h-4 w-4 text-buddy-gray-300" />
                            );
                          })}
                        </div>
                      </td>
