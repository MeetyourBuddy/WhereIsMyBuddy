...
const ProfileCompletion = () => {
  ...
  const [profileMethod, setProfileMethod] = useState<"upload" | "avatar">(
    "avatar"
  );
  ...
  const completionPercentage =
    Object.values(completionItems).filter(Boolean).length * 50;
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          <Tabs
            ...
            value={profileMethod}
            onValueChange={(value) =>
              setProfileMethod(value as "upload" | "avatar")
            }
          >
          ...
          <div className="space-y-4">
            ...
            <FormDescription>
              Select at least one goal that describes what you want to achieve
              on this platform
            </FormDescription>
                ...
                <div key={goal.id} className="flex items-start space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      handleGoalChange(checked, goal.id)
                    }
                  />
