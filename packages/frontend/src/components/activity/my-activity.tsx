      ...
      <ul className="mx-auto grid w-full max-w-2xl grid-cols-1 items-start gap-4 md:grid-cols-2">
        {cards.map((card, index) => (
          <motion.div
            ...
            className="flex h-[500px] cursor-pointer flex-col rounded-xl border-2 border-neutral-100 p-4 transition-all duration-200 hover:bg-neutral-50 hover:shadow-lg dark:hover:bg-neutral-800"
          >
            <div className="flex w-full flex-col gap-4">
              ...
              <div className="flex flex-col items-center justify-center gap-4">
                <motion.h3
                  ...
                  className="text-center text-lg font-medium text-neutral-800 dark:text-neutral-200"
                >
                  {card.title}
                </motion.h3>
                <motion.p
